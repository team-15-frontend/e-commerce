...
export default function ProductCard({ isLoading: isLoadingProduct, product }) {
  ...
  return (
    <div className="card group">
      <Swiper
        images={isOutOfStock || isLoading ? product?.images.slice(0, 1) : product?.images}
        isLoading={isLoading}
        ...
        {!isLoading && (
          <>
            ...
            <Button
              ...
              size="md-square"
              className={cn(
                'invisible absolute top-0 right-0 z-10 mt-4 mr-4 rounded-full border-none bg-neutral-50 text-xl text-neutral-500 opacity-0 transition-all group-hover:visible group-hover:opacity-100 hover:text-red-600 dark:hover:text-red-400',
      ...
      <div className="flex flex-col gap-2">
        <div
          ...
          className={cn('p-4 pb-0', isLoading ? 'pointer-events-none' : 'cursor-pointer')}
        >
          ...
          {!isLoading ? (
            <div className="relative flex gap-1 text-lg font-medium text-neutral-500">
              ...
              <LuStar />
              <LuStar />
              <div className="text-accent-600 dark:text-accent-400 absolute top-0 left-0 flex gap-1 group-hover:text-teal-600 group-hover:dark:text-teal-400">
